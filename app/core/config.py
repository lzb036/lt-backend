...
class Settings(BaseModel):
    ...
    listing_product_workers: int = 4
    listing_image_prepare_workers: int = 8
...
def build_settings() -> Settings:
    ...
    return Settings(
        ...
        listing_product_workers=max(1, _env_int("LT_LISTING_PRODUCT_WORKERS", 4)),
        listing_image_prepare_workers=max(1, _env_int("LT_LISTING_IMAGE_PREPARE_WORKERS", 8)),
